...
class VMSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                .mvcMatchers(POST, "/login/**", "/client", "/dealer").permitAll()
                .mvcMatchers(POST, "/client/refresh-token/**", "/dealer/refresh-token/**").permitAll()
                .mvcMatchers(POST, "/client/logout", "/dealer/logout").permitAll()
